...
public class TokenSigner
    ...
    public static void Main(String[] args)
    {
        ...
        try
        {
            Console.WriteLine("Fetching XML Configuration File");
        ...
        if(node == null) 
        {
            Console.WriteLine("Error in configuration file format");
            Console.WriteLine("Press Any Key To Exit");
            Console.ReadLine();
            Environment.Exit(0);
        }
        ...
        if (tokenSigner.TokenPin == null || tokenSigner.TokenCertificate == null || docPath == "")
        {
        ...
        {
            Console.WriteLine("The file " + docPath + @"\SourceDocumentJson.json is not exist");
            Console.WriteLine("Press Any Key To Exit");
            Console.ReadLine();
            Environment.Exit(0);
        }
        ...
        //Start serialize
        Console.WriteLine("Serializing Json Documents");
        ...
        {
            Console.WriteLine("Signing Invoice");
        ...
        Console.WriteLine("Signed Invoice Created Successfully, check the FullSignedDocument");
        Console.WriteLine("Press Any Key to Exit");
        Console.ReadLine();
        Environment.Exit(0);
